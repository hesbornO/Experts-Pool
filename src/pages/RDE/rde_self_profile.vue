      ...
      <span>
          <span v-if="rdeSelfProfile && Object.keys(rdeSelfProfile).length === 0" class="pb-2 text-xl">
            ...
            <span class="flex justify-between">
              ...
              <span v-if="!signUpData.email_confirmed" class="text-orange-500 font-mono">{{activeLanguage.store.sign_up_form.verify_email}} <a :href="`mailto:`+signUpData.email" class="text-blue-500">'{{signUpData.email?signUpData.email:''}}'</a> {{activeLanguage.store.sign_up_form.to_proceed}}</span>
                <span></span>
            </span>
