        ...
        <div :class="['px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800 ']">
          ...
          <div class="grid grid-cols-3 gap-4">
            ...
            <label class="block mt-4 text-sm">
              ...
              <select v-model="countryCode" @change="mapCountryCode('phone')" class="w-1/2 rounded-md ">
          ...
          <div class="grid grid-cols-3 gap-4">
            ...
            <label class="block mt-4 text-sm">
              <span class="text-gray-700  font font-semibold dark:text-gray-400">Phone</span>
              <select v-model="nextOfKinCountryCode" @change="mapNOKCountryCode('next_of_kin_phone')" class="w-1/2 rounded-md ">
                <optgroup label="Countries">
                  <option value="" disabled selected>Select country</option>
                  <option data-countryCode="DZ" value="213">Algeria (+213)</option>
                  <option data-countryCode="AD" value="376">Andorra (+376)</option>
