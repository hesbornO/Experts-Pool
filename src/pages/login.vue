      ...
      <div class="flex flex-col overflow-y-auto md:flex-row">
        ...
        <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
          ...
          >
            ...
            <p class="mt-1">
              <router-link class="w-full" to="/create-account"><span
                  class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline">Create account</span>
              </router-link>
            </p>
          </div>
        </div>
...
export default {
  ...
  computed:{
    ...mapGetters(['getCurrentToken','allTransactions','getErrorMessage']),
  },
  mounted() {
  }
}
