<template>
  <dashboard_layout page_title="Users">

    <div class="mb-3 flex flex-row justify-end">      
      <router-link
          :to="{name:'CreateUser', params:{}}"
    ...
    <data_table v-bind="$attrs">
      <template v-slot="{item}">        
        ...
        <td class="px-4 py-3 text-sm capitalize">{{item.username?item.username:''}}</td>
        <td class="px-4 py-3 text-sm capitalize">{{item.phone_number?item.phone_number:''}}</td>
        <td class="px-4 py-3 text-sm capitalize">
            
        </td>
        <td class="px-4 py-3 text-sm capitalize"> {{item.staff_number}}</td>
        <td class="px-4 py-3 text-sm flex flex-row space-x-1">   
          <router-link
              :to="{name:'UpdateUser', params:{userId:item.id}}"
          ...
          <!-- <router-link
              :to="{name:'DeleteUser', params:{userId:item.id}}"
